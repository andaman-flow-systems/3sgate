...
const CATEGORIES = ['All', 'Thai Cuisine', 'Seafood & BBQ', 'Street Food', 'Shan & Northern', 'Traditional Cuisine', 'Asian & Japanese', 'Regional Fusion', 'Cafés & Drinks', 'Desserts & Bakery'];
...
export default function FoodPage() {
  ...
  const getCategoryLabel = (cat: string) => {
    switch (cat) {
      ...
      case 'Traditional Cuisine': return t('foodCatMyanmar');
