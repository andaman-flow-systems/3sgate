...
export function seedIfEmpty(): void {
  ...
  // News (8 articles)
  setAll(KEYS.news, [
    { id: 'n1', title: 'Important Update for Communities in Thailand', content: 'The Thai government has announced new immigration policies affecting foreign nationals living and working in Thailand. All residents are urged to check their visa status and renew documentation before the deadline. Failure to comply may result in fines or deportation. The policy changes are expected to take effect in Q3 2024.', category: 'myanmar-thailand', image: 'https://images.unsplash.com/photo-1555400038-63f5ba517a47?w=600&q=80', author: 'Admin', publishedAt: '2024-05-12T08:00:00Z', status: 'published', createdAt: '2024-05-12T00:00:00Z' },
    { id: 'n2', title: 'New Work Permit Regulations Announced', content: 'New work permit regulations have been issued for foreign nationals working in Thailand. Key changes include streamlined renewal processes, new document requirements, and updated fee structures. Workers are strongly encouraged to consult with official authorities to ensure full compliance.', category: 'myanmar-thailand', image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&q=80', author: 'Admin', publishedAt: '2024-05-10T08:00:00Z', status: 'published', createdAt: '2024-05-10T00:00:00Z' },
    { id: 'n3', title: 'Relief Support for Displaced Communities in Border Areas', content: 'Humanitarian organisations are providing relief supplies and medical assistance to refugees along the border. Emergency shelter, food packages, and medical care are being distributed. International NGOs are calling for continued donations and volunteer support.', category: 'myanmar-abroad', image: 'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=600&q=80', author: 'Admin', publishedAt: '2024-05-08T08:00:00Z', status: 'published', createdAt: '2024-05-08T00:00:00Z' },
    { id: 'n4', title: 'Community Clean-Up Event in Chiang Mai', content: 'The local community in Chiang Mai organised a successful community clean-up event, bringing together over 200 volunteers to clean public parks and streets. The event was praised by local authorities and has strengthened community bonds.', category: 'myanmar-thailand', image: 'https://images.unsplash.com/photo-1542601906897-93a9e6b5b6a5?w=600&q=80', author: 'Admin', publishedAt: '2024-05-05T08:00:00Z', status: 'published', createdAt: '2024-05-05T00:00:00Z' },
    { id: 'n5', title: 'Education Support Programs for Youth in Thailand', content: 'Several NGOs and social enterprises have launched new education programmes to support youth in Thailand. The programmes include language classes, vocational training, and scholarship opportunities for outstanding students. Applications are now open.', category: 'myanmar-abroad', image: 'https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=600&q=80', author: 'Admin', publishedAt: '2024-05-03T08:00:00Z', status: 'published', createdAt: '2024-05-03T00:00:00Z' },
    { id: 'n6', title: 'Cultural Celebrations and Gatherings Abroad', content: 'Communities around the world gathered to celebrate cultural events, traditional food festivals, and community gatherings. The celebrations served as a powerful reminder of shared heritage and the importance of preserving cultural traditions abroad.', category: 'myanmar-news', image: 'https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=600&q=80', author: 'Admin', publishedAt: '2024-01-04T08:00:00Z', status: 'published', createdAt: '2024-01-04T00:00:00Z' },
    { id: 'n7', title: 'Flood Relief Effort for Displaced Families in Chiang Rai', content: 'Following severe flooding in the Chiang Rai region, community organisations have mobilised to provide emergency relief to displaced families. Food, clean water, and temporary shelter are being distributed. Donations can be made through 3SGate.', category: 'myanmar-thailand', image: 'https://images.unsplash.com/photo-1504711434969-e33886168f5c?w=600&q=80', author: 'Admin', publishedAt: '2024-04-28T08:00:00Z', status: 'published', createdAt: '2024-04-28T00:00:00Z' },
    { id: 'n8', title: 'International Day of the Refugee — Stories of Resilience', content: 'On International Refugee Day, we share the resilient stories of families who have rebuilt their lives abroad. From education to business, these stories of strength and hope inspire our entire community and remind the world of the human cost of displacement.', category: 'myanmar-abroad', image: 'https://images.unsplash.com/photo-1531206715517-5c0ba140b2b8?w=600&q=80', author: 'Admin', publishedAt: '2024-04-20T08:00:00Z', status: 'published', createdAt: '2024-04-20T00:00:00Z' },
  ] as NewsPost[]);

  // Gallery (10 artworks — THB prices)
  setAll(KEYS.gallery, [
    { id: 'g1', title: 'Sunset Over Bagan', artist: 'Kaung Htet', image: 'https://images.unsplash.com/photo-1499781350541-7783f6c6a0c8?w=600&q=80', description: 'Oil painting depicting a sunset over the ancient pagodas of Bagan. Rich warm tones and textured brushwork.', category: 'Painting', forSale: true, price: 8500, createdAt: '2024-05-01T00:00:00Z' },
    ...
    { id: 'g3', title: 'Portrait of Resilience', artist: 'Zar Win', image: 'https://images.unsplash.com/photo-1541367777708-7905fe3296c0?w=600&q=80', description: 'A moving portrait capturing the quiet strength of an elder woman — painted from life in Mandalay.', category: 'Portrait', forSale: true, price: 6200, createdAt: '2024-04-15T00:00:00Z' },
    ...
    { id: 'g6', title: 'Unity', artist: 'Thida Win', image: 'https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?w=600&q=80', description: 'A large-format acrylic painting on canvas symbolising people united in hope and solidarity.', category: 'Painting', forSale: true, price: 11000, createdAt: '2024-03-15T00:00:00Z' },
    { id: 'g7', title: 'Market Colours', artist: 'Hnin Thazin', image: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=600&q=80', description: 'Vibrant watercolour of a busy street market, filled with colour, people, and the energy of daily life.', category: 'Watercolour', forSale: true, price: 5500, createdAt: '2024-03-10T00:00:00Z' },
    ...
    { id: 'g10', title: 'Teak Forest at Dusk', artist: 'Win Naing', image: 'https://images.unsplash.com/photo-1448375240586-882707db888b?w=600&q=80', description: 'A sweeping landscape of teak forest bathed in the golden light of dusk. Oil on linen, 120x80cm.', category: 'Landscape', forSale: true, price: 9200, createdAt: '2024-01-20T00:00:00Z' },
  ] as ArtworkItem[]);
  ...
  setAll(KEYS.products, [
    ...
    { id: 'p5', name: 'Traditional Lacquerware Bowl', price: 750, category: 'Crafts', image: 'https://images.unsplash.com/photo-1590874103328-eac38a683ce7?w=400&q=80', description: 'Traditional lacquerware handcrafted by master artisans in Bagan using centuries-old techniques.', inStock: true, createdAt: '2024-04-10T00:00:00Z' },
    { id: 'p6', name: 'Handwoven Silk Longyi', price: 650, category: 'Clothing', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=80', description: 'Authentic handwoven longyi, beautifully handwoven from pure silk. Available in multiple patterns.', inStock: true, createdAt: '2024-04-05T00:00:00Z' },
    ...
    { id: 'p8', name: 'Carved Teak Elephant', price: 490, category: 'Crafts', image: 'https://images.unsplash.com/photo-1581235720704-06d3acfcb36f?w=400&q=80', description: 'Hand-carved teak wood elephant — a classic artisan souvenir and elegant home decoration.', inStock: true, createdAt: '2024-03-28T00:00:00Z' },
  ...
  setAll(KEYS.jobs, [
    ...
    { id: 'j5', title: 'Cook and Kitchen Assistant', company: 'Community Food Court', location: 'Chiang Rai', type: 'full-time', salary: '11,000 – 13,000 THB / month', description: 'Experienced cook needed for our growing food court. Must have knowledge of traditional regional dishes.', requirements: ['Cooking experience required', 'Basic food handling hygiene knowledge', 'Works well in a team'], contactEmail: 'hire@mmfoodcourt.com', isRecruitmentAgent: false, status: 'active', createdAt: '2024-04-28T00:00:00Z' },
  ...
  setAll(KEYS.food, [
    ...
    { id: 'f5', name: 'Traditional Kitchen Chiang Mai', category: 'Traditional Cuisine', location: 'Chiang Mai', address: '123 Nimman Rd, Suthep, Mueang, Chiang Mai 50200', phone: '+66 53 123 456', image: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=600&q=80', description: 'Traditional home-style cooking with authentic recipes from Mandalay and Yangon. Signature Mohinga, Laphet Thoke (Tea Leaf Salad), and curries.', priceRange: '$', rating: 4.8, openHours: '10:00 – 22:00', createdAt: '2024-04-15T00:00:00Z' },
    ...
    { id: 'f9', name: 'Mae Sot Border Bistro', category: 'Regional Fusion', location: 'Mae Sot', address: '12 Asia Road, Mae Sot, Tak 63110', image: 'https://images.unsplash.com/photo-1521017432531-fbd92d768814?w=600&q=80', description: 'A cozy fusion bistro blending authentic Thai spices with regional tea culture, parathas, and rich curry flavors.', priceRange: '$', rating: 4.5, openHours: '08:00 – 21:00', createdAt: '2024-03-20T00:00:00Z' },
