...
export function seedIfEmpty(): void {
  ...
  setAll(KEYS.food, [
    ...
    { id: 'f5', name: 'Myanmar Kitchen Chiang Mai', category: 'Myanmar Cuisine', location: 'Chiang Mai', address: '123 Nimman Rd, Suthep, Mueang, Chiang Mai 50200', phone: '+66 53 123 456', image: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=600&q=80', description: 'Traditional Myanmar home-style cooking with authentic recipes from Mandalay and Yangon. Signature Mohinga, Laphet Thoke (Tea Leaf Salad), and curries.', priceRange: '$', rating: 4.8, openHours: '10:00 – 22:00', createdAt: '2024-04-15T00:00:00Z' },
    ...
    { id: 'f9', name: 'Mae Sot Border Bistro', category: 'Myanmar-Thai Fusion', location: 'Mae Sot', address: '12 Asia Road, Mae Sot, Tak 63110', image: 'https://images.unsplash.com/photo-1521017432531-fbd92d768814?w=600&q=80', description: 'A cozy fusion bistro blending authentic Thai spices with Myanmar tea culture, parathas, and rich curry flavors.', priceRange: '$', rating: 4.5, openHours: '08:00 – 21:00', createdAt: '2024-03-20T00:00:00Z' },
